 ...
 */
public class MbsWebActivityTest extends BaseWebActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MbsWebFragmentTest mbsWebFragment =
                (MbsWebFragmentTest) getSupportFragmentManager().findFragmentById(R.id.content_Frame_1);

        if (mbsWebFragment == null) {
            mbsWebFragment = MbsWebFragmentTest.newInstance(getIntent().getExtras());
            ActivityUtils.addFragmentToActivity(
                    getSupportFragmentManager(), mbsWebFragment, R.id.content_Frame_1);
        }
        mbsPersenter = new WebPluginPresenter(mbsWebFragment, this, MbsWebActivityTest.class, getIntent().getExtras());
