...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    //private static final int[] LAYOUT_ATTRS = new int[] { android.R.attr.state_enabled // state_enabled
    //};
    ...
    private SimpleDateFormat formatter = new SimpleDateFormat("MM 月 dd 日 HH:mm", Locale.CHINA);
...
//        screenWidth = metrics.widthPixels;
        ...
        final TypedArray a = context
                .obtainStyledAttributes(attrs, R.styleable.swiperefresh);
//		setEnabled(a.getBoolean(0, true));
        setEnabled(true);

//        ptr_drawable = a.getResourceId(R.styleable.swiperefresh_roateImage, R.drawable.default_ptr_rotate);
        ptr_drawable = a.getResourceId(R.styleable.swiperefresh_roateImage, R.drawable.loading_12);
        ptr_flip_drawable = a.getResourceId(R.styleable.swiperefresh_flipImage, R.drawable.default_ptr_flip);
        finished_drawable = a.getResourceId(R.styleable.swiperefresh_finishedImage, R.drawable.default_tips);
        ...
        mProgressBar = new SwipeProgressBar(this, textSize, textColor, ptr_drawable, ptr_flip_drawable, finished_drawable, type);
        a.recycle();
    }
...
//    Log.e("loading","参数 setProgressBarProperty diff:"+diff+"\n"
//    +"directionL:"+direction);
    ...
    public void setRefreshing(boolean refreshing) {
        if (mRefreshing != refreshing) {
            ...
            if (refreshing) {
                ...
                mProgressBar.stop();
                postDelayed(mReturnToStartPosition, 1000);
            }
            //mReturnToStartPosition.run();
        }
    }
    ...
    private void ensureTarget() {
        ...
        final DisplayMetrics metrics = getResources().getDisplayMetrics();
        if (headerHeight == -1) {
            headerHeight = (int) (getFontHeight(textSize) * 2 + 5 * metrics.density * 4);
        }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        try {
            ...
            if (!isEnabled() || mReturningToStart) {
            	Log.e("oye", "return false  ==="+ev.getAction());
...
//                            }
                ...
                case MotionEvent.ACTION_UP:
                    final int mPointerIndex = MotionEventCompat.findPointerIndex(ev,
                            mActivePointerId);
                    if (mPointerIndex < 0) {
                        Log.e(LOG_TAG,
                                "Got ACTION_MOVE event but have an invalid active pointer id.");
